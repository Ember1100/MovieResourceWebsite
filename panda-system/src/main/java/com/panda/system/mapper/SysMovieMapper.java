...
public interface SysMovieMapper {
    ...
    //获取会员电影
    List<SysMovie> selectVipMovie(Long movieCategoryId);

    //获取会员电影
    List<SysMovie> selectNewestMovie(@Param("movieCategoryId") Long movieCategoryId, @Param("startDate")Date startDate,@Param("endDate")Date endDate);

    List<SysMovie> selectMovie(Long movieCategoryId);
