  ...
  <el-container>
    <el-header>
      <div class="header-inner">
        ...
        <!-- </a> -->
        <el-menu :default-active="activeUrl" class="nav-menu" mode="horizontal" :router="true"
          active-text-color="#409EFF" text-color="#000000">
    ...
    <el-footer>
      ...
      <div class="footer">
        ...
        <div class="bottom-link">
          <a href="https://beian.miit.gov.cn/" target="_blank">桂ICP备2022009408号-1</a>
        </div>
      </div>
...
<script>
  export default {
    ...
    created() {
      ...
      const picture = JSON.parse(this.loginUser.userPicture);
